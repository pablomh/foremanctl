...
All containers are connected to one or more named Podman bridge networks instead of sharing the host network namespace. This limits the blast radius of a compromised container: a container can only reach the services it is explicitly connected to.
